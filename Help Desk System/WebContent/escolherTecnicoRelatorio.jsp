...
<html lang="en">
 ...
 <aside> 
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-table"></i> Gerar Relatórios</h3>
					<ol class="breadcrumb">
						<li><i class="icon_cog"></i>Gerar Relatórios</li>
						<li><i class="fa fa-th-list"></i>Técnicos</li>
					</ol>
				</div>
			</div>
              <!-- page start-->
                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              ...
                              <% 	Servicos servicos = new Servicos();
                              		List<Usuario> lista = servicos.getListaTecnicos();
                              		...
                              		for(Usuario u : lista){ %>
                              			<tr>            
                                 			...
                                 			<td><%= u.getTelefone()%></td>                                
                                 			<td>
                                 				<form action = "gerarRelatorioTecnico.jsp"  method = "post" class = "nivel">
                                    				<div class="form-group ">                                          
                                          				<div class="col-lg-6">
                                          					<input type="hidden" value="<%= u.getEmailUsuario()%>" name="idTecnico">
