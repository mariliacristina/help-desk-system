				...
				<ul class="sidebar-menu">
					...
					<li class="sub-menu"><a href="javascript:;" class=""> <i
						...
						<ul class="sub">
							...
							<li><a class="" href="chamadosTecnicoConcluidos.jsp">ConcluíDdos</a></li>
					...
					<li class="sub-menu"><a href="javascript:;" class=""> <i
						...
						<ul class="sub">
							...
							<li><a class="" href="chamadosDoTecnicoConcluidos.jsp">ConcluíDdos</a></li>
							<!--<li><a class="" href="grids.html">Grids</a></li> -->
						</ul></li>
					...
					<li><a class="" href="estatisticasTecnico.jsp"> <i
							class="icon_piechart"></i> <span>Estatíssticas</span>
                  	...
                  	<section class="panel">
                     	...
                     	<div class="panel-body">
	                        ...
	                        <div class="panel-body">
				                ...
				                <% if(!request.getParameter("status").equals("Em Espera")){ %>
	                        	...
	                        	<% }else { %>
	                        		<div class="btn-group">
	                        			<form class = "form-horizontal" action="retirarChamadoEspera.jsp" method="post">
										   ...
										   <button type = "submit" class="btn btn-default" id="bnt-retirarEspera">
		                        				Retirar da Espera
		                        				<!-- i class="icon_document_alt"></i-->
		                        		   </button>
										</form>
										  		...
										  		<div class="modal-dialog" role="document">
										    		<div class="modal-content">
										      			...
										      			<div class="modal-body">
										        			<form action = "colocarChamadoEspera.jsp" method = "post">
										          				<div class="form-group">
										            				<textarea class="form-control" id="message-text" name = "motivoPendencia"></textarea>
										          				</div>
										          				<input type="hidden" value="<%= request.getParameter("status")%>" name="status" />
                                            					<input type="hidden" value="<%= request.getParameter("assunto")%>" name="assunto" />
                                            					<input type="hidden" value="<%= request.getParameter("dataAbertura")%>" name="dataAbertura" />
