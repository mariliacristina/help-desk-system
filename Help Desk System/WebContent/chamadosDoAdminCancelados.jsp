...
<html lang="en">
  <head>
    ...
    <link href="css/style.css" rel="styl
    esheet">
    <link hr
    ef="css/style-responsive.css" rel="stylesheet" />
		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-th-list"></i>Cancelados</li>
					</ol>
				</div>
			</div>
                           ...
                           <tbody>
                              ...
                              <% Usuario user = (Usuario) session.getAttribute("usuario"); 
                              	 ...
                              	 for(Chamado chamado : list){ 
                              	 	if(chamado.getStatus().equals("Cancelado")){ %>
                                      <tr>
                                         ...
                                         <td>
                                            <div class="col-lg-3">
                                            	<form action="meusChamadosAdminClienteo.jsp" method="post"  >
