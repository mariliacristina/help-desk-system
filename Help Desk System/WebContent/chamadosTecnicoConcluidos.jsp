		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-th-list"></i>Concluídos</li>
					</ol>
				</div>
			</div>
              <!-- page start-->
                           ...
                           <tbody>
                              ...
                              <% Usuario user = (Usuario) session.getAttribute("usuario"); 
                              	 ...
                              	 for(Chamado chamado : list){ 
                              	 	if(chamado.getStatus().equals("Concluido e Atendido Dentro do Prazo") || chamado.getStatus().equals("Concluido Fora do Prazo e Atendido Dentro do Prazo") || chamado.getStatus().equals("Concluido Dentro do Prazo com Atendimento Atrasado") || chamado.getStatus().equals("Concluido Fora do Prazo com Atendimento Atrasado")){ %>
                                     <tr>
                                         ...
                                         <td>
                                             <div class="col-lg-2">
                                            	<form action="meusChamadosTecnico.jsp" method="post"  >
